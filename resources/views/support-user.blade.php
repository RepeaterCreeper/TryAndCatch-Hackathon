                        ...
                        <div class="chat-self p-4" style="display: flex;">
                            <div style="display: flex; gap: 16px; align-items: center;">
                                ...
                                <div style="display: flex; flex-direction: column;">
                                    <p style="margin: 0;">Joseph Chua</p>
                                    <div class="bg-primary rounded"
                                        style="min-width: 300px; padding: 8px; color: white;">
                                        <p>Message body</p>
                                        <small class="grey-text float-right">November 28, 2020 1:47pm</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div style="display: flex; gap: 16px; align-items: center; flex-direction: row-reverse;">
                                ...
                                <div style="display: flex; flex-direction: column; text-align: right;">
                                    ...
                                    <div class="bg-info rounded" style="min-width: 300px; padding: 8px; color: white;">
                                        <p>There is no status update for your requested document.</p>
                                        <small class="grey-text float-left">November 28, 2020 1:47pm</small>
                                    </div>
                                </div>
                            </div>
                        </div>
